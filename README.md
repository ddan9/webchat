...
- уведомление о входе человека в чат? (было раньше такое)
...
- синхронизация
- нотифи ошибка авторизации при неправильном пароле клиента
- возвращать клиенту пустой массив (именно массив) для предотвращения ошибки при пустой базе данных
...
- нужно всё-таки сделать ОПЦИЮ включения/отчключения шифрования баз (не всем надо, не везде есть)
