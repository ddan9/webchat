...
- авторство в хелпу
- добавить $device в $address как соль
...
- пересмотреть скрытые кнопки, правильно ли они скрыты + добавить туда полный экран т.к. не нужен
- косяк в чате с исчезновением кнопки (неплавное)
- косяк в просмотрщике с кнопкой фулскрина
- добавить в соль имя веб агента
- черный и белый списки (ip и ник)
- сжатие файлов
- оптимизировать работу базы файлов (рассосать на инфу и сами файлы, можно попробовать просто дублировать без тела)
- закрывать поле ника если включены запреты
...
- на клиентской стороне выводить даты (начала) для сообщений 
...
- ограничение ширины области вывода, для широкоэкранных мониторов
